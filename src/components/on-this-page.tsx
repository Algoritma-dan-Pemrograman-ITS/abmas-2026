...
export function OnThisPage() {
  ...
  useEffect(() => {
    ...
    // Syncing with an external system (the rendered DOM) after each
    // navigation, not deriving state from props/state — a valid effect use,
    // so the setState-in-effect lint warning is a false positive here.

 ...
 * hairline border underneath. Holds the brand lockup and a search affordance.
 */
...
/**
 * Search affordance styled as a faux input. Not wired up to real search —
 * a calm placeholder with a keyboard hint, exactly how the Tailwind docs
 * present their search trigger.
 */
// function SearchBar() {
//   return (
//     <button

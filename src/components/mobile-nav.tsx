...
export function MobileNav() {
  ...
  // Portal target (document.body) only exists client-side; this mount flag
  // gates the SSR/CSR mismatch, so the setState-in-effect lint warning is a
  // false positive for this specific pattern.

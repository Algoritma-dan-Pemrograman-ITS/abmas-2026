...
/**
 * A captioned figure for screenshots and diagrams. Uses a plain <img> (these
 * are documentation assets of varying sizes) wrapped in a thin border,
 * optionally capped so small UI snippets are not upscaled into blur.
 */
